...
namespace xengine
{
	...
	{
		m_shader = ShaderManager::LoadVF("post process", "shaders/effect/effect.quad.vs", "shaders/effect/effect.post_processing.fs");
		m_shader->Bind();
	...
	void PostRenderer::GenerateEffect(Texture* source)
	{
