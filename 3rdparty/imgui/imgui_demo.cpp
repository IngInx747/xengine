...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Trees"))
    {
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            if (node_clicked != -1)
            {
                // BuildFromVertices selection state. Process outside of tree loop to avoid visual inconsistencies during the clicking-frame.
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    // BuildFromVertices closing queue
